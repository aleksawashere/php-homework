...
INSERT INTO `telefoni` (`mob_id`, `naziv`, `model`, `godina_proizvodnje`, `cena`, `vlasnik_id`) VALUES
(1, 'Sony', 'Xperia XA2', 2017, 35000, 1),
(2, 'Apple', 'iPhone XR', 2018, 65000, 1),
(3, 'Samsung', 'Galaxy S20 Ultra', 2020, 105000, 1),
(4, 'Nokia', '3310', 2000, 11000, 1),
(5, 'LG', 'G5', 2016, 23000, 1);
...
(1, 'Aleksa Dimitrijević', 'aleksa', 'aleksa'),
(5, 'Mina Đeković', 'mina', 'mina'),
(6, 'Misko Miskic', 'misko', 'misko');
...
--
ALTER TABLE `telefoni`
  ADD CONSTRAINT `telefoni_ibfk_1` FOREIGN KEY (`vlasnik_id`) REFERENCES `vlasnik` (`vlasnik_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
